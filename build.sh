...
repo_name="spigot_mh_minecraft_jdk8_2"
...
manhunt_jar="${project_dir}/$2"


if [ ! -f "$manhunt_jar" ] ; then
    echo "usage: $(basename $0) <mc version> <name of manhunt jar>"
    exit 1
fi
